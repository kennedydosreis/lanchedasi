    ...
    sanduiches: [
        {
            id: 'sanduiche-1',
            name: 'X-Salada',
            description: 'Pão, ovo, hambúrguer, queijo, presunto, alface e tomate',
            price: 12.00,
            category: 'sanduiches',
        ...
        },
        {
            ...
            description: 'Pão, ovo, hambúrguer, queijo, presunto, alface, tomate e calabresa',
            price: 14.00,
            category: 'sanduiches',
        ...
        },
        {
            ...
            description: 'Pão, ovo, hambúrguer, queijo, presunto, alface, tomate e bacon',
            price: 15.00,
            category: 'sanduiches',
        ...
        },
        {
            ...
            description: 'Pão, ovo, hambúrguer, queijo, presunto, alface, tomate e salsicha',
            price: 15.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-5',
            name: 'X-Salada Duplo',
            description: 'Pão, dois ovos, dois hambúrgueres, queijo, presunto, alface e tomate',
            price: 17.00,
            category: 'sanduiches',
        ...
        },
        {
            ...
            description: 'Pão, ovo, hambúrguer, queijo, presunto, alface, tomate e cebola',
            price: 13.00,
            category: 'sanduiches',
        ...
        },
        {
            ...
            description: 'Pão, ovo, hambúrguer, queijo, presunto, alface, tomate e banana',
            price: 13.00,
            category: 'sanduiches',
        ...
        },
        {
            ...
            description: 'Pão, hambúrguer, queijo, presunto, alface, tomate e salsicha',
            price: 10.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-10',
            name: 'X-Tudo',
            description: 'Pão, hambúrguer, ovo, queijo, presunto, alface, tomate, calabresa, salsicha e bacon',
            price: 20.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-11',
            name: 'X-Bacon',
            description: 'Pão, ovo, queijo, presunto, alface, tomate e bacon',
            price: 12.00,
            category: 'sanduiches',
            image: '/assets/produtos/x-bacon.jpg'
        },
        {
            id: 'sanduiche-12',
            name: 'X-Calabresa',
            description: 'Pão, ovo, queijo, presunto, alface, tomate e calabresa',
            price: 10.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-13',
            name: 'X-Maionese',
            description: 'Pão, hambúrguer, queijo, presunto, alface, tomate e maionese caseira',
            price: 8.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-14',
            name: 'X-Salsicha',
            description: 'Pão, ovo, queijo, presunto, alface, tomate e salsicha',
            price: 12.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-15',
            name: 'X-Egg',
            description: 'Pão, ovo, queijo, alface e tomate',
            price: 8.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-16',
            name: 'X-Banana',
            description: 'Pão, hambúrguer, queijo, presunto, alface, tomate e banana',
            price: 11.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-17',
            name: 'Bauru',
            description: 'Pão, ovo, queijo, presunto, alface e tomate',
            price: 8.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-18',
            name: 'Americano',
            description: '3 pães de forma, ovo, queijo, presunto, alface e tomate',
            price: 9.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-20',
            name: 'Misto',
            description: '2 Pães de forma, queijo e presunto',
            price: 5.00,
            category: 'sanduiches',
        ...
        },
        {
            id: 'sanduiche-21',
            name: 'Misto Duplo',
            description: '3 Pães de forma, dois queijos e dois presuntos',
            price: 8.00,
            category: 'sanduiches',
        ...
        },
        {
            ...
            description: '3 Pães de forma e dois queijos',
            price: 8.00,
            category: 'sanduiches',
